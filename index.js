...
var $author$project$Index$updatePostPreviewLikes = function (postpreview) {
...
var $author$project$Index$update = F2(
	function (msg, model) {
		return _Utils_update(
			model,
			{
				postPreviews: A2($elm$core$List$map, $author$project$Index$updatePostPreviewLikes, model.postPreviews)
			});
	});
...
var $author$project$Index$viewLoveButton = function (postPreview) {
...
var $author$project$Index$viewPostPreview = function (postPreview) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href(postPreview.authorpage)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src(postPreview.authorimage)
									]),
								_List_Nil)
							])),
						$elm$html$Html$text(' '),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(postPreview.authorname)
									])),
								A2(
								$elm$html$Html$span,
								_List_fromArray(
								...
								_List_fromArray(
									[
										$elm$html$Html$text(postPreview.date)
									]))
							])),
						$author$project$Index$viewLoveButton(postPreview)
					])),
				A2(
				$elm$html$Html$a,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(postPreview.articletitle)
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text(postPreview.articlepreview)
							])),
						A2(
						$elm$html$Html$span,
						_List_Nil,
...
var $author$project$Index$viewPosts = function (postPreviews) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Index$viewPostPreview, postPreviews));
};
									...
									[
										...
										_List_fromArray(
											[
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		_List_fromArray(
																			[
																				$elm$html$Html$Attributes$class('nav-link disabled'),
																				$elm$html$Html$Attributes$href('#')
																			]),
																		_List_fromArray(
																			[
												...
												$author$project$Index$viewPosts(model.postPreviews)
											])),
										A2(
										$elm$html$Html$div,
										_List_fromArray(
...
var $author$project$Index$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Index$initialModel, update: $author$project$Index$update, view: $author$project$Index$view});
