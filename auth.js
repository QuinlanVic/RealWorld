...
var $author$project$Auth$main = $elm$browser$Browser$element(
	{init: $author$project$Auth$init, subscriptions: $author$project$Auth$subscriptions, update: $author$project$Auth$update, view: $author$project$Auth$view});
_Platform_export({'Auth':{'init':$author$project$Auth$main(
