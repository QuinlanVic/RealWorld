...
var $author$project$Auth$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Auth$initialModel, update: $author$project$Auth$update, view: $author$project$Auth$view});
