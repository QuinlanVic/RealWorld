										...
										[
											...
											_List_fromArray(
												[
													...
													_List_Nil),
													$elm$html$Html$text($krisajenkins$elm_exts$Exts$Html$nbsp + 'Follow Eric Simons'),
													A2(
													$elm$html$Html$span,
													_List_fromArray(
														[
											...
											_List_fromArray(
												[
													...
													_List_Nil),
													$elm$html$Html$text($krisajenkins$elm_exts$Exts$Html$nbsp + 'Favorite Post'),
													A2(
													$elm$html$Html$span,
													_List_fromArray(
														[
												...
												[
													...
													_List_fromArray(
														[
															...
															_List_fromArray(
																[
																	$elm$html$Html$text('With supporting text below as a natural lead-in to additional content.')
																]))
														])),
													A2(
													$elm$html$Html$div,
