...
var $author$project$Post$saveNewComment = function (model) {
...
var $author$project$Post$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Post$initialModel, update: $author$project$Post$update, view: $author$project$Post$view});
