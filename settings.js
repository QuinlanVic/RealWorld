...
var $author$project$Settings$viewForm = F2(
...
var $author$project$Settings$view = function (user) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
											...
											[
												...
												_List_fromArray(
													[
														...
														A2($author$project$Settings$viewForm, 'text', 'Your Name'),
														A2(
														$elm$html$Html$fieldset,
														_List_fromArray(
															[
														...
														A2($author$project$Settings$viewForm, 'text', 'Email'),
														A2($author$project$Settings$viewForm, 'password', 'Password'),
														A2(
...
var $author$project$Settings$main = $author$project$Settings$view($author$project$Settings$initialModel);
_Platform_export({'Settings':{'init':_VirtualDom_init($author$project$Settings$main)(0)(0)}});}(this));