...
var $author$project$Settings$update = F2(
	function (message, userset) {
		switch (message.$) {
			case 'SavePic':
				var urlpic = message.a;
...
var $author$project$Settings$UpdateSettings = {$: 'UpdateSettings'};
...
var $author$project$Settings$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Settings$initialModel, update: $author$project$Settings$update, view: $author$project$Settings$view});
_Platform_export({'Settings':{'init':$author$project$Settings$main(
