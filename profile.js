...
var $author$project$Profile$updatePostPreviewLikes = function (postpreview) {
	return postpreview.liked ? _Utils_update(
		postpreview,
		{liked: !postpreview.liked, numlikes: postpreview.numlikes - 1}) : _Utils_update(
		postpreview,
		{liked: !postpreview.liked, numlikes: postpreview.numlikes + 1});
};
...
var $author$project$Profile$ToggleLike = {$: 'ToggleLike'};
var $author$project$Profile$viewLoveButton = function (postPreview) {
	var buttonClass = postPreview.liked ? _List_fromArray(
		[
			...
			A2($elm$html$Html$Attributes$style, 'color', '#fff'),
			A2($elm$html$Html$Attributes$style, 'border-color', 'black'),
			$elm$html$Html$Events$onClick($author$project$Profile$ToggleLike)
		]) : _List_fromArray(
		[
			$elm$html$Html$Attributes$class('btn btn-outline-primary btn-sm pull-xs-right'),
			$elm$html$Html$Events$onClick($author$project$Profile$ToggleLike)
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_Nil),
				$elm$html$Html$text(
				' ' + $elm$core$String$fromInt(postPreview.numlikes))
			]));
};
var $author$project$Profile$viewPostPreview = function (post) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href(post.authorpage)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$src(post.authorimage)
									]),
								_List_Nil)
							])),
						$elm$html$Html$text(' '),
						...
						$author$project$Profile$viewLoveButton(post)
					])),
				A2(
				$elm$html$Html$a,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(post.articletitle)
							])),
						A2(
						$elm$html$Html$p,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text(post.articlepreview)
							])),
						A2(
						$elm$html$Html$span,
						_List_Nil,
...
var $author$project$Profile$viewPosts = function (postsMade) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Profile$viewPostPreview, postsMade));
};
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('posts-toggle')
													]),
												_List_fromArray(
													[
														A2(
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		_List_fromArray(
																			[
																				$elm$html$Html$text('Favorited Posts')
																			]))
																	]))
															]))
													])),
												$author$project$Profile$viewPosts(model.postsMade)
											]))
									]))
							]))
					])),
...
var $author$project$Profile$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Profile$initialModel, update: $author$project$Profile$update, view: $author$project$Profile$view});
_Platform_export({'Profile':{'init':$author$project$Profile$main(
