...
var $author$project$Profile$initialModel = {authorbio: '', authorimage: '', authorname: ''};
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$href('post-meta'),
													...
													[
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		_List_fromArray(
																			[
																				$elm$html$Html$Attributes$src('http://i.imgur.com/N4VcUeJ.jpg')
																			]),
																		_List_Nil)
																	])),
																$elm$html$Html$text($krisajenkins$elm_exts$Exts$Html$nbsp),
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$elm$html$Html$text('The song you won\'t ever stop singing. No matter how hard you try.')
																	])),
																A2(
																$elm$html$Html$p,
																_List_Nil,
...
var $author$project$Profile$main = $author$project$Profile$view($author$project$Profile$initialModel);
