...
var $author$project$Editor$CreatePost = {$: 'CreatePost'};
var $author$project$Editor$SaveContent = function (a) {
...
var $author$project$Editor$view = function (post) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
													...
													[
															...
															[
																...
																_List_fromArray(
																	[
																		...
																		$elm$html$Html$Events$onInput($author$project$Editor$SaveContent)
																	]),
																_List_Nil)
															])),
														A2(
														...
														_List_fromArray(
															[
																...
																$elm$html$Html$Events$onClick($author$project$Editor$CreatePost)
															]),
														_List_fromArray(
															[
...
var $author$project$Editor$main = $elm$browser$Browser$sandbox(
	{init: $author$project$Editor$initialModel, update: $author$project$Editor$update, view: $author$project$Editor$view});
